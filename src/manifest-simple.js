...
const data = {
    ...
    "pagination": [
        ...
        {   
            "id": "bates",
            "type": "simple",
            "note": [{"@value": "bates numbers added on the xerox reprint", "@language": "en"}]
        }
    ],
    "sections": [
        {
            ...
            "imagelist": [
                {
                    ...
                    "note": [
                        {"@value": "this is an intro page, some editions would have that before the scans", "@language": "en"}
                    ]
                },
                {
                ...
                },
                {
                    ...
                    "pagination": { "pgfolios": {"value": "1b", "section": "intro"}, "bates": {"value": "2"} }
                },
                {
                ...
                },
                {
                    ...
                    "pagination": { "pgfolios": {"value": "1'a", "section": "intro"} },
                    "rotation": 180
                }
            ]
        }
