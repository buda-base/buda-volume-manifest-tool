...
var exceptions = {0: "ཐིག", 10: "བཅུ།", 15: "བཅོ་ལྔ།", 18: "བཅོ་བརྒྱད།", 20: "ཉི་ཤུ", 30: "སུམ་བཅུ།"};
...
var pagination_types = {
    folios: {
        ...
        str_to_seqnum : function(s) {
            ...
            if (apo_idx == -1)
                first_part = s.substring(0, s.length-1);
            else
                first_part = s.substring(0, apo_idx);
...
function get_get_info(pagination_type, index0_pagination, section_template, section_name) {
...
console.log("img04:")
console.log(img04info);
var img05info = get_info(3);
console.log("img05:")
console.log(img05info);